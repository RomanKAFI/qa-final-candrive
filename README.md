...
1 can_drive.py – implementation of can_drive(age) (returns True if age ≥ 16).
2 test_can_drive.py – unit tests for can_drive(age) using Python unittest.
3 test_login_selenium.py – Selenium tests for:
  - successful login: test1 / Test12456
  - failed login: test1 / test1234
4 .gitignore – ignores .venv/, __pycache__/ and other non-essential files.
